...
/** @type {string} */
const CACHE_VERSION = '1730399877|2379835726';
/** @type {string} */
const CACHE_PREFIX = 'Tasty Terminator-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Tasty Terminator.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Tasty Terminator.html","Tasty Terminator.js","Tasty Terminator.offline.html","Tasty Terminator.icon.png","Tasty Terminator.apple-touch-icon.png","Tasty Terminator.worker.js","Tasty Terminator.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Tasty Terminator.wasm","Tasty Terminator.pck"];
