...
func generate_roads(pos : Vector2i, size : Vector2i):
	for x in size.x:
		for y in size.y:
			...
			var surrounding = [round_noise(updated_pos+Vector2i(1,1)), round_noise(updated_pos+Vector2i(-1,1)), round_noise(updated_pos+Vector2i(-1,-1)), round_noise(updated_pos+Vector2i(1,-1)), round_noise(updated_pos+Vector2i(1,0)), round_noise(updated_pos+Vector2i(0,1)), round_noise(updated_pos+Vector2i(-1,0)), round_noise(updated_pos+Vector2i(0,-1))]
